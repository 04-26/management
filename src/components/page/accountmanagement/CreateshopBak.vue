      ...
      <div id="div_second_table" data-spy="scroll" data-target="#navbar-example" data-offset="0" style=" height:100%;overflow:auto;position:relative;">
        ...
        >
          <el-form-item label="激活码：" prop="shopSign">
            <el-input style="width:200px" v-model="ruleForm.shopSign"></el-input>
          </el-form-item>
          <el-form-item label="微信小程序的appid：" prop="appid">
            <el-input style="width:200px" v-model="ruleForm.appid"></el-input>
          </el-form-item>
          <el-form-item label="微信小程序的secret：" prop="secret">
            <el-input style="width:200px" v-model="ruleForm.secret"></el-input>
          </el-form-item>
          <el-form-item style="width:200px" label="店铺名称：" prop="shopName">
            <el-input v-model="ruleForm.shopName"></el-input>
          </el-form-item>
          <el-form-item style="width:300px" label="主营类目：" prop="flag">
            <el-select style="width:200px" v-model="ruleForm.flag" placeholder="选择经营类目">
          ...
          <el-form-item  style="width:100%" label="* 选择省/市/区：" prop="region">
            <el-select
              style="width:100px"
              v-model="citymsg"
              placeholder="选择省"
          ...
          <div class="home">
            <div
              class="home-content"
              style="padding-bottom:10px;font-size: 14px;color: #606266;line-height: 30px;"
            >
          ...
          <el-form-item label="">
            <el-checkbox-group v-model="initdata">
              <el-checkbox label="initdata" name="initdata" :true-label="1" :false-label="0">是否初始化数据</el-checkbox>
            </el-checkbox-group>
          </el-form-item>
          <el-form-item>
