  ...
  <div>
      <el-form ref="form" :model="form" label-width="80px" :rules="rules">
          ...
          <el-form-item label="联系电话" prop="tel">
              <el-input v-model="form.tel" placeholder="请输入收货人联系电话"></el-input>
          </el-form-item>
          ...
          <el-form-item label="详细地址" prop="address">
              <el-input v-model="form.address" placeholder="请选择收货人详细地址"></el-input>
          </el-form-item>
          <el-form-item label="">
...
export default {
    ...
    data(){
        return {
            ...
            rules:{
                name:{required:true,message:'请输入收货人姓名',trogger:'blur'},
                tel:{required:true,message:'请输入收货人联系电话',trogger:'blur'},
        ...
        save(){
            ...
            this.$refs.form.validate((valid)=>{
                if(valid){
                    ...
                    this.req.post("/store/updatereturninfo",param).then(res=>{
                        if(res.data.code=='SUCCESS' && res.data.sub_code=='SUCCESS'){
